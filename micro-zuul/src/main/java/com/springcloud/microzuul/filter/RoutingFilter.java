package com.springcloud.microzuul.filter;
...
public class RoutingFilter extends ZuulFilter {
    ...
    public Object run() throws ZuulException {
        ...
        MultiValueMap<String, String> headers = this.buildZuulRequestHeaders(request);
        MultiValueMap<String, String> params = this.buildZuulRequestQueryParams(request);
